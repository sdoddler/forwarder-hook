...
A hook is identified by its HookHash, on the following examples I provide some HookHashs generated by me on different networks to make your life easier. Don't install Hooks from sources you don't trust.
